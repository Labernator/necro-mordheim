...
export const ActionTypesPage = () => {
    ...
    return <React.Fragment>
        ...
        <p>{`Performing a Double action counts as making two actions. If a model can only perform one action during its activation for any reason, it may not perform a Double action.`}</p>
